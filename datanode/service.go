...
const (
	...
	baseUrlTestnet    = "https://api.n06.testnet.vega.xyz"
...
func LoadDepositsForParty(partyId string) ([]Deposit, error) {
	...
	//log.Infof(baseUrl  + "/withdrawals/party/" + partyId)
	log.Infof(baseUrl + "/parties/" + partyId + "/deposits")

	resp, err := http.Get(baseUrl + "/parties/" + partyId + "/deposits")
	if err != nil {
		return nil, err
	}
...
func LoadAccountsForParty(partyId string) ([]Account, error) {
	resp, err := http.Get(baseUrl + "/parties/" + partyId + "/accounts")
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func LoadRewardsForParty(partyId string) ([]Reward, error) {
	resp, err := http.Get(baseUrl + "/parties/" + partyId + "/rewards")
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func LoadLiquidityProvisionsForParty(partyId string, marketId string) ([]LiquidityProvision, error) {
	log.Info(baseUrl + "/liquidity-provisions/party/" + partyId + "/market/" + marketId)

	resp, err := http.Get(baseUrl + "/liquidity-provisions/party/" + partyId + "/market/" + marketId)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func LoadWithdrawalsForParty(partyId string) ([]Withdrawal, error) {
	...
	resp, err := http.Get(baseUrl + "/withdrawals/party/" + partyId)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func LoadGovernanceProposals(partyId string) ([]Proposal, error) {
	log.Debugf(baseUrl + "/parties/" + partyId + "/proposals")
	resp, err := http.Get(baseUrl + "/parties/" + partyId + "/proposals")
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func LoadDelegationsForParty(partyId string) ([]Delegation, error) {
	resp, err := http.Get(baseUrl + "/delegations?party=" + partyId)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func LoadDelegations() ([]Delegation, error) {
	resp, err := http.Get(baseUrl + "/delegations")
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func LoadEpochForId(id string) (*Epoch, error) {
	...
	log.Infof(baseUrl + "/epochs?id=" + id)

	resp, err := http.Get(baseUrl + "/epochs?id=" + id)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
