...
var gqlQueryPartiesAccountsMakerReceived string = `query ($pagination: Pagination!) {
...
func (s *Service) sortByPartyRewardsMakerReceived(socials map[string]verifier.Social) ([]Participant, error) {
