...
func (s *Service) sortByPartyAccountGeneralBalanceWeekend(socials map[string]verifier.Social) ([]Participant, error) {
	...
	for _, party := range sParties {
		...
		if party.ID == "db010ceb5e4a282ab08ac99fd0379d7ccebdac2bdb01c6d1d2adcd7ee69b439c" {
			balanceGeneral = balanceGeneral - 29800.357421875000000000
		}

		if party.ID == "a21856f12757cabacd1bea37fe9ac71720a8cf14205114790f70db949aa55112" {
			balanceGeneral = balanceGeneral - 1499
		}
